...
export default function CreatePayment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await new Promise((resolve) => setTimeout(resolve, 3000));
      toast.success(res.data.message || `Payment created successfully! ID: ${res.data.id}`, {
        position: "top-right",
        autoClose: 3000,
  ...
  return (
   <div className="max-w-md mx-auto mt-12 p-8 bg-white shadow-xl rounded-xl border border-gray-200">
      <h2 className="text-2xl font-bold text-[#007786] mb-6 text-center">Create Payment</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {showAccountInfo && (
          <div className="border-t border-gray-300 pt-6 space-y-4">
            <h3 className="text-lg font-semibold text-[#007786] mb-4">Account Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col">
